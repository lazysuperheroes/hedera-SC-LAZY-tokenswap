...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface IBurnableHTSInterface extends Interface {
  ...
  export interface IBurnableHTS extends BaseContract {
    
    connect(runner?: ContractRunner | null): IBurnableHTS;
    waitForDeployment(): Promise<this>;

    interface: IBurnableHTSInterface;
