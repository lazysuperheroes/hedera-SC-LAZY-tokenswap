...
/* eslint-disable */
  ...
  import type { BaseTokenSwap, BaseTokenSwapInterface } from "../../BaseTokenSwap.sol/BaseTokenSwap.js";
  ...
  {
    "inputs": [],
    "name": "ExceedsMaxSerials",
    "type": "error"
  },
  {
    "inputs": [],
    "name": "FTTransferFailed",
    "type": "error"
  },
  {
    "inputs": [],
  ...
  export class BaseTokenSwap__factory {
    static readonly abi = _abi;
    static createInterface(): BaseTokenSwapInterface {
      return new Interface(_abi) as BaseTokenSwapInterface;
    }
    static connect(address: string, runner?: ContractRunner | null): BaseTokenSwap {
      return new Contract(address, _abi, runner) as unknown as BaseTokenSwap;
    }
  }
