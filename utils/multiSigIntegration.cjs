...
async function contractExecuteFunctionMultiSig(
	...
	if (!multiSigConfig.enabled) {
		const { contractExecuteFunction } = require('./solidityHelpers.cjs');
...
function displayMultiSigHelp() {
	...
	console.log('  node scripts/unified/adminManagement.cjs --contract <id> --pause --multisig');
	console.log('  node scripts/unified/adminManagement.cjs --contract <id> --pause --multisig --threshold=2');
	console.log();
	console.log('Offline Mode (air-gapped signing):');
	console.log();
	console.log('  Step 1 - Freeze and export:');
	console.log('    node scripts/unified/adminManagement.cjs --contract <id> --pause --multisig --export-only');
	console.log();
	console.log('  Step 2 - Signers sign offline:');
	console.log('    (Use the hedera-multisig CLI to sign the exported .tx file)');
	console.log();
	console.log('  Step 3 - Execute with collected signatures:');
	console.log('    node scripts/unified/adminManagement.cjs --contract <id> --pause --multisig --offline \\');
